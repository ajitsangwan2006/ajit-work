node {
    ...
    stage('Publish Docker Image') {
        ...
        sh 'docker tag spring-boot-docker-image 639760561846.dkr.ecr.us-east-1.amazonaws.com/docker-aws-repository/spring-boot-docker-image:0.1.0'
        sh 'docker push 639760561846.dkr.ecr.us-east-1.amazonaws.com/docker-aws-repository/spring-boot-docker-image:0.1.0'
    }
}